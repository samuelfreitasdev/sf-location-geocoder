...
package gradle.kotlin.dsl.plugins._b0015fc1a6b0bc68af6fdd78038a1af9
...
/**
 * The `net.saliman` plugin group.
 */
@org.gradle.api.Generated
internal
class `NetSalimanPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `net.saliman`.
 */
internal
val `NetPluginGroup`.`saliman`: `NetSalimanPluginGroup`
    get() = `NetSalimanPluginGroup`(plugins)


/**
 * The `net.saliman.properties` plugin implemented by [net.saliman.gradle.plugin.properties.PropertiesPlugin].
 */
internal
val `NetSalimanPluginGroup`.`properties`: PluginDependencySpec
    get() = plugins.id("net.saliman.properties")
...
/**
 * The `properties` plugin implemented by [net.saliman.gradle.plugin.properties.PropertiesPlugin].
 */
internal
val `PluginDependenciesSpec`.`properties`: PluginDependencySpec
    get() = this.id("properties")
